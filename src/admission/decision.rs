//! The decision itself: whether a wanted entry fits, and what goes first.
//!
//! Split from the door above it when `admission.rs` became `admission/mod.rs`,
//! which may only declare. The rules this applies -- who is a candidate, and
//! why the coldest goes first -- are set out there.

use crate::catalog::Residency;

use super::budget::Budget;
use super::room::{Freed, Room};
